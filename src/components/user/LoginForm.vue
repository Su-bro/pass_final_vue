<template>
  ...
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form>
      <input type="text" id="login" v-model="userid" ref="userid" class="fadeIn second" name="login" placeholder="id">
      <input type="text" id="password" v-model="userpwd" ref="userpwd" class="fadeIn third" name="login" placeholder="password">
      <input type="submit" @click.prevent="checkValue" class="fadeIn fourth" value="Log In">
    </form>
...
export default {
    ...
    methods:{
        ...
        login(){
            ...
            this.member.userpwd=this.userpwd;
            console.log(this.memeber);
            this.$store.dispatch('loginMember',this.member);
            this.move();
